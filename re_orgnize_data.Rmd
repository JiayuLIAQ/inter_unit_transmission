...
dt_innova[, datetime := floor_date(datetime, unit = "5 minute")]
dt_velocicalc[, datetime := floor_date(datetime, unit = "5 minute")]
dt_wind_sensor[, datetime := floor_date(datetime, unit = "5 minute")]
