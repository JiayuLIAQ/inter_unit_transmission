...
```{r}
dt_wind_sensor[,-c("WIMDA_u","WIMDA_v","WIMWV_u","WIMWV_v")] %>% fwrite("clena_data_5_min/wind_sensor/dt_wind_sensor.csv")
dt_velocicalc %>% fwrite("clena_data_5_min/velocicalc/dt_velocicalc.csv")
dt_innova %>% fwrite("clena_data_5_min/innova/dt_innova.csv")
...
```{r write out raw without conditions}
# make them wide
