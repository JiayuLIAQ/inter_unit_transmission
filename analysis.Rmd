...
dt_innova <- fread("clean_data_5_min/innova/dt_innova.csv")
dt_velocicalc <- fread("clean_data_5_min/velocicalc/dt_velocicalc.csv")
dt_wind_sensor <- fread("clean_data_5_min/wind_sensor/dt_wind_sensor.csv")
...
```{r echo=FALSE, fig.height=6, fig.width=11.5, warning=FALSE}
